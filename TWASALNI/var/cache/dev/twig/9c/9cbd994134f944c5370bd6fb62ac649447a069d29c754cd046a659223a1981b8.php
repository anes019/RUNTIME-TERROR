...
class __TwigTemplate_6ca6018cfffdf7e348990e803fab244d37713547741118e34a1961c4e1de9eec extends \Twig\Template
{
    private $source;
    private $macros = [];
   ...
   <link href=\"//netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap.min.css\" rel=\"stylesheet\" id=\"bootstrap-css\">
       ...
       <div class=\"container\">
        ...
        echo " DT  <h4 style=\"color: red\"> +prix de commande</h4></strong></h4></td>
                      ...
                      <a href=\"";
        // line 86
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("reservation_archiver", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["reservation"]) || array_key_exists("reservation", $context) ? $context["reservation"] : (function () { throw new RuntimeError('Variable "reservation" does not exist.', 86, $this->source); })()), "id", [], "any", false, false, false, 86)]), "html", null, true);
        echo "\"> <button type=\"button\" class=\"btn btn-success btn-lg btn-block \" style=\"width: 470px\">
                          Accepter commande    <span class=\"glyphicon glyphicon-ok-sign\"></span>
                       </button></a>
                          <a href=\"";
        // line 89
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("reservation_rejet", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["reservation"]) || array_key_exists("reservation", $context) ? $context["reservation"] : (function () { throw new RuntimeError('Variable "reservation" does not exist.', 89, $this->source); })()), "id", [], "any", false, false, false, 89)]), "html", null, true);
        echo "\"> <button type=\"button\" class=\"btn btn-danger btn-lg btn-block \" style=\"width: 470px\">
                                  Refuser commande    <span class=\"glyphicon glyphicon-ok-sign\"></span>
                              </button></a>
                      </center>
                       </td>
...
";
    ...
    {
        return array (  232 => 98,  220 => 89,  214 => 86,  205 => 80,  194 => 72,  178 => 59,  174 => 58,  170 => 57,  166 => 56,  142 => 37,  134 => 32,  129 => 30,  124 => 28,  119 => 26,  102 => 11,  92 => 10,  80 => 106,  78 => 10,  69 => 3,  59 => 2,  36 => 1,);
    }
           ...
           <div class=\"row\">
               <div class=\"well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3\">
                   ...
                   <div class=\"row\">
                      ...
                      <a href=\"{{ path('reservation_archiver', { 'id': reservation.id }) }}\"> <button type=\"button\" class=\"btn btn-success btn-lg btn-block \" style=\"width: 470px\">
                          Accepter commande    <span class=\"glyphicon glyphicon-ok-sign\"></span>
                       </button></a>
                          <a href=\"{{ path('reservation_rejet', { 'id': reservation.id }) }}\"> <button type=\"button\" class=\"btn btn-danger btn-lg btn-block \" style=\"width: 470px\">
                                  Refuser commande    <span class=\"glyphicon glyphicon-ok-sign\"></span>
                              </button></a>
                      </center>
                       </td>
...
{% endblock %}
       <br>
       <br>
   {% endblock %}", "reservation/show.html.twig", "C:\\wamp64\\www\\RUNTIME-TERROR\\TWASALNI\\app\\Resources\\views\\reservation\\show.html.twig");
    }
}
