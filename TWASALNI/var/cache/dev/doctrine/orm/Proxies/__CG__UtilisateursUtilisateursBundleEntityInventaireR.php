 ...
 */
class InventaireR extends \Utilisateurs\UtilisateursBundle\Entity\InventaireR implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\InventaireR' . "\0" . 'id', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\InventaireR' . "\0" . 'montant', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\InventaireR' . "\0" . 'dateI', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\InventaireR' . "\0" . 'partenaire', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\InventaireR' . "\0" . 'done'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InventaireR $proxy) {
